...
//------------------------------------------------------------------
void SetupParamsH(fsi::SimParams *paramsH, fsi::Real hdimX, fsi::Real hdimY,
                  fsi::Real hthick, fsi::Real basinDepth,
                  fsi::Real fluidInitDimX, fsi::Real fluidHeight) {
  ...
  paramsH->cMax =
      paramsH->cMin + paramsH->binSize0 * fsi::mR3(side0x, side0y, side0z);
  ...
  paramsH->straightChannelBoundaryMin =
      paramsH->cMinInit; // fsi::mR3(0, 0, 0);  // 3D channel
  paramsH->straightChannelBoundaryMax =
      paramsH->cMaxInit; // fsi::mR3(3, 2, 3) * paramsH->sizeScale;
  //************************** modify pressure ***************************
  ...
  //stuff *****************************
  fsi::Real mBinSize = paramsH->binSize0; // Best solution in that case may be
                                          // to change cMax or cMin such that
                                          // periodic
