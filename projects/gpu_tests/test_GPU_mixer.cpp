...
int main(int argc, char* argv[]) {
    ...
    switch (mixer_type) {
        case MIXER_TYPE::INTERNAL:
            mesh_filename = granular::GetDataFile("test_GRAN_mixer/internal_mixer.obj");
            g[0] = 0;
            g[1] = 0;
            g[2] = -980;
            break;
        case MIXER_TYPE::EXTERNAL_VERTICAL:
            mesh_filename = granular::GetDataFile("test_GRAN_mixer/external_mixer_vertical.obj");
            g[0] = 0;
            g[1] = 0;
            g[2] = -980;
            break;
        ...
        case MIXER_TYPE::EXTERNAL_ANGLED:
            mesh_filename = granular::GetDataFile("test_GRAN_mixer/external_mixer_angled.obj");
            g[0] = 0;
            g[1] = 0;
            g[2] = -980;
            break;
