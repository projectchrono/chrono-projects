...
void ShowUsage(std::string name) {
    std::cout << "usage: " + name + " <json_file> <output_dir> <psi_L> <incline angle> <static friction>" << std::endl;
}
...
int main(int argc, char* argv[]) {
    ...
    params.static_friction_coeffS2W = std::stof(argv[5]);
    ...
    // Vector parallel to the plane going up
