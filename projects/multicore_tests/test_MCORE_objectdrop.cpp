...
// =============================================================================
//
// Chrono::Multicore demo program for contact of various shapes.
//
    ...
    switch (shape_g) {
        ...
        case ChCollisionShape::Type::BOX:
            // A single box
            {
                ...
                utils::AddBoxGeometry(ground.get(), mat_g, ChVector3d(bigHx, bigHy, bigHz), ChVector3d(0, 0, -bigHz));
            }
            break;
    }
...
// =============================================================================
void CreateObject(ChSystemMulticore* system) {
    double rho_o = 2000.0;
