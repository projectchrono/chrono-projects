...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void ChCSLDriver::SetThrottleDelta(double delta) {
    m_throttle_delta = delta;
}

void ChCSLDriver::SetSteeringDelta(double delta) {
    m_steering_delta = delta;
}

void ChCSLDriver::SetBrakingDelta(double delta) {
    m_braking_delta = delta;
}

void ChCSLDriver::SetGains(double steering_gain, double throttle_gain, double braking_gain) {
