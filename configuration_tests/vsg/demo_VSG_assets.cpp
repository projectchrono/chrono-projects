...
int main(int argc, char* argv[]) {
    ...
    body->AddVisualShape(chrono_types::make_shared<ChVisualShapeSphere>(0.03), ChFrame<>(ChVector3d(-6, 1, -2.5), QUNIT));
    body->AddVisualShape(chrono_types::make_shared<ChVisualShapeSphere>(0.03), ChFrame<>(ChVector3d(-6, 1, +0.5), QUNIT));
    ...
    vis->AddVisualModel(chrono_types::make_shared<ChVisualShapeSphere>(0.03), ChFrame<>(ChVector3d(-6, 1, -5 - 0.4), QUNIT));
    vis->AddVisualModel(chrono_types::make_shared<ChVisualShapeSphere>(0.03), ChFrame<>(ChVector3d(-6, 1, -5 + 0.4), QUNIT));
